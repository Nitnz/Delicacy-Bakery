...
const delivery = () => {
  ...
  <div className="text-center lg:text-left lg:w-1/2">
    ...
    <p className="font-maglio text-neutral-200 text-lg sm:text-xl lg:text-3xl leading-relaxed max-w-xl mx-auto lg:mx-0">
      ...
      Let us turn your special moments into unforgettable memories.
    </p>
    <div className="mt-6">
      <a href="#" className="font-semibold underline text-281612 bg-white px-4 py-2 rounded hover:bg-gray-200 transition">
        VIEW MORE
      </a>
    </div>
  </div>
